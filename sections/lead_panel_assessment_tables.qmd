...
lead_unsum_table <- flextable(lead_unsum_table, 
  ...
  # Set caption
  set_caption(lead_unsum_table, "Summary statistics for the abuse votes by each LEAD panelists (not summarized for each MedStar ID)") %>%
...
lead_sum_table   <- flextable(lead_sum_table,  
                  col_keys = c("var", "cat", "n_Initial assessment", "formatted_stats_Initial assessment", 
                               ...
                               "formatted_stats_Post-detect assessment")) %>%
  # Set caption
  set_caption(lead_sum_table, "Summary statistics for the abuse determinations for each MedStar ID grouped by assessment type") %>%
