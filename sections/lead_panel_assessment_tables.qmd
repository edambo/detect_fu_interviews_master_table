...
This page contains tables of baseline LEAD Panel Assessment characteristics for the DETECT F/U Interview participants. Statistics for the 
...
<!-- ## Create a data frame that contains summary statistics for the abuse votes by all the LEAD panelists (not summarized for each MedStar ID)  grouped by assessment type -->

```{r}
#| label: lead-panelists-votes-stats-list-overall
#| echo: false
...
<!-- ## Create a data frame that contains summary statistics for the abuse votes summarized for each MedStar ID and grouped by assessment type -->

```{r}
#| label: lead-panel-vote-summaries-stats-list-overall
#| echo: false
...
```{r}
# Convert tables to flextable
lead_unsum_table <- as_flextable(lead_unsum_table)
lead_sum_table <- as_flextable(lead_sum_table)
