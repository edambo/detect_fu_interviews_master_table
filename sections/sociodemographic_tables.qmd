...
```{r}
#| label: socio-demo-add-cont-stats-list
#| echo: false
...
```{r}
#| label: socio-demo-cont-stats-list-to-df
#| echo: false
...
<!-- ### Categorical data -->
```{r}
#| label: socio-demo-add-cat-stats-list
#| echo: false
...
print(soc_doc, target = "../sections/socio_demo_overall.docx")
```
