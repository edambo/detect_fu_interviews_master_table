...
cls_desc <- readRDS("../sections/variable_descriptions/clutter_scale_var_desc.rds")
...
print(cls_doc, target = "../sections/clutter_scale_tables.docx")
```
